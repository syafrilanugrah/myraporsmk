...
class Cetak_leger extends CI_Controller {
    ...
    public function cetak() {
        ...
        $html = '<p align="left"><b>LEGER NILAI PENGETAHUAN & KETERAMPILAN</b>
                <br>
                Kelas : '.$this->d['dw']['nmkelas'].', Nama Wali : '.$this->d['dw']['nmguru'].', Tahun Pelajaran '.$this->d['ta'].'<hr style="border: solid 1px #000; margin-top: -10px"></p>';
        ...
        foreach ($queri_siswa as $s) {
            ...
            $jumlah = $jml_np+$jml_nk;
            $html .= '<td class="ctr">'.($jumlah).'</td><td>ket</td></tr>';
        }
