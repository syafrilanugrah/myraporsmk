<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h4 class="title">Data Jurusan</h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="kode_jurusan" class="form-control" id="kode_jurusan" required>
                    </div>
                </div>
                <div class="form-group">
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#kode_jurusan").val(data.data.kode_jurusan);
