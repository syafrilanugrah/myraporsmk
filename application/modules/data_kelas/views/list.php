        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="jurusan" required="" class="form-control" name="jurusan">

                        <?php
                        $select_jurusan = $this->db->query("SELECT id, jurusan FROM m_jurusan")->result_array();
                        foreach ($select_jurusan as $key) {
                            ?>
