...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl">SMK Negeri 2 Parepare</td>
		...
		<tr><td colspan="6"><b>B. PENGETAHUAN & KETERAMPILAN</b></td></tr>
		<tr><td colspan="6">
			<table class="table">
				<thead>
				<tr>
					<th colspan="2" rowspan="2" width="50%">Mata Pelajaran</th>
		...
		<tr><td colspan="6"><b>C. EKSTRAKULIKULER</b></td></tr>
		<tr><td colspan="6">
			<table class="table">
				<thead>
					<tr>
