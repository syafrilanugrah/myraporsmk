<div class="card">
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <label for="kode" class="control-label">Diterima di Jurusan</label>
                    <?php echo form_dropdown('jurusan', $p_jurusan, $data['jurusan_id'], 'class="form-control" id="jurusan" required'); ?>
                </div>
            </div>
            ...
            <div class="col-md-2">
			 ...
			 <div class="col-md-3">
                <div class="form-group">
                    <label for="kode" class="control-label">Diterima Smt</label>
                    <?php echo form_dropdown('diterima_smt', $p_diterima_smt, $data['diterima_smt'], 'class="form-control" id="diterima_smt" required'); ?>
                </div>
            </div>
		</div>
		<div class="row">
