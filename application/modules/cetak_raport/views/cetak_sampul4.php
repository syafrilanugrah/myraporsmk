...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/LogoSMKN2.png" style="margin-top: 10px; width: 90px; height: 80px">
			</td>
			<td style="text-align: center"><b>KEMENTERIAN PENDIDIKAN DAN KEBUDAYAAN REPUBLIK INDONESIA<br>
			DINAS PENDIDIKAN POVINSI SULAWESI SELATAN<br>
			...
			Telp : 0421 (21962) | Web : www.smknegeri2parepare.sch.id</span>
			</td>
		</tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		Parepare, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala Sekolah<br>
		<br>
		<br>
		<br>
		<br>
		<b><u>DRS. H. FATTAHUDDIN, MH</u></b><br>
		NIP. 19630630 198803 1 009
	</div>
