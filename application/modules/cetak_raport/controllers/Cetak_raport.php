...
class Cetak_raport extends CI_Controller {
    ...
    public function cetak($id_siswa,$tasm) {
        ...
        $kelompok = array("A", "B","C1","C2");

            $arr_huruf = array("a","b","c","d","e");

            $d['nilai_utama'] .= '<tr><td colspan="10"><b>Muatan Nasional</b></td></tr>';
            $no = 1;
            ...
            foreach ($q_mapel as $i=>$m) {
                ...
                $npd = empty($nilai_pengetahuan[$idx]['desk']) ? "-" : "Penguasaan pengetahuan "." ".$nilai_pengetahuan[$idx]['desk'];
                ...
                $nkp = empty($nilai_keterampilan[$idx]['predikat']) ? "-" : $nilai_keterampilan[$idx]['predikat'];
                    $nkd = empty($nilai_keterampilan[$idx]['desk']) ? "-" : "Penguasaan keterampilan "." ".$nilai_keterampilan[$idx]['desk'];
            ...
            //kelompok B
            $d['nilai_utama'] .= '<tr><td colspan="10"><b>Muatan Kewilayahan</b></td></tr>';
            ...
            //kelompok C1
            $d['nilai_utama'] .= '<tr><td colspan="10"><b>Muatan Permintaan Kejuruan</b></td></tr>
            <tr><td colspan="10"><b>C1. Dasar Bidang Keahlian</b></td></tr>';
            $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C1' AND tambahan_sub = 'NO'")->result_array();
            ...
            //kelompok C2
            $d['nilai_utama'] .= '<tr><td colspan="10"><b>C2. Dasar Bidang Keahlian</b></td></tr>';
            $q_mapel = $this->db->query("SELECT * FROM m_mapel WHERE kelompok = 'C2' AND tambahan_sub = 'NO'")->result_array();
