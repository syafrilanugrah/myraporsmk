...
<div class="wrapper">
    ...
    -->
    	<div class="sidebar-wrapper">
            <div class="logo">
                <img src="<?php echo base_url(); ?>aset/img/LogoSMKN2Parepare.png" width="30%" height="30%" style="display: block; margin: auto;">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i class="pe-7s-study"></i> SMK Negeri 2 Parepare
                </a>
            </div>
            <ul class="nav">
                <?php 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Apa anda ingin keluar.?</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary"href="<?php echo base_url(); ?>login/logout" onclick="return hilangkan_gambar();">
            YA
        </a>
